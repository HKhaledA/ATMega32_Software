...
#define LCD_Control_reg_DIR GPIOB->DDR_reg.Reg
#define LCD_Control_reg_OP  GPIOB->PORT_reg.Reg
#define LCD_Control_reg_IP	GPIOB->PIN_reg.Reg
#define LCD_Data_Reg_DIR	GPIOB->DDR_reg.Reg	
#define LCD_Data_Reg_OP		GPIOB->PORT_reg.Reg
#define LCD_Data_Reg_IP		GPIOB->PIN_reg.Reg
